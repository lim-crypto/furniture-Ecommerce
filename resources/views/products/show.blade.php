        ...
        <div class="col-md-12">
            <div class="card mb-3">
                <div class="row no-gutters align-items-center shadow">
                    <div class="col-md-6">
                        <img src="{{ asset('storage/images/products/'.$product->image) }}" class="img-fluid"  width="500" height="500"   alt="{{$product->name}}">
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <div class="input-group my-3 ">
                                        ...
                                        <input type="number" name="quantity" class="form-control form-control-sm text-center input-number" value="" min="1" max="{{$product->quantity}}">
                                        <span class="input-group-btn">
                                    ...
                                    <form action="{{ route('carts.add', $product->id) }}">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-success btn-block"> <i class="fas fa-cart-plus"> </i> Add to Cart</butt>
                                    </form>
                                    @endif
                                </div>
                            </div>
